...
class Factura(models.Model):
    ...
    cliente = fields.Many2one('prue01.clientes', 'Cliente', required=True)
    lineas = fields.Many2many('prue01.lineasfactura', string="Lineas")
...
class Proveedores(models.Model):
    ...
    nombre = fields.Char('Nombre', required=True)
    direccion = fields.Many2one('prue01.direccion', 'Direccion', required=False)
